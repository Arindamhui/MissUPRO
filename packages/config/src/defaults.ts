...
export const PK = {
  ...
  WINNER_REWARD_COINS: 500,
  LOSER_REWARD_COINS: 150,
  DRAW_REWARD_COINS: 250,
} as const;
...
export const LEVEL_XP = {
  WATCH_SECONDS_PER_INTERVAL: 60,
  WATCH_XP_PER_INTERVAL: 2,
  WATCH_MIN_SECONDS: 60,
  STREAM_SECONDS_PER_INTERVAL: 60,
  STREAM_XP_PER_INTERVAL: 4,
  STREAM_MIN_SECONDS: 60,
  GIFT_COINS_PER_INTERVAL: 10,
  GIFT_XP_PER_INTERVAL: 1,
} as const;
