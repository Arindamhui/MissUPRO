      ...
      <header className="h-16 border-b border-slate-200/80 bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-full flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <Link href="/login?role=admin" className="text-[#ff6b3d] hover:underline">
              Admin Access
            </Link>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          <div className="hidden lg:block pt-10">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#ff6b3d]">Clerk + DB roles</p>
            ...
            <p className="mt-4 text-slate-600 max-w-lg leading-7">
              Identity lives in Clerk. Authorization lives in PostgreSQL. Every admin and agency session is revalidated against the backend before protected UI or APIs are allowed through.
            </p>
            ...
            <div className="mt-8 grid gap-4 max-w-lg">
              <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-sm">
                ...
                <div className="text-sm text-slate-600 mt-2 leading-6">
                  New agency accounts finish Clerk signup first, then complete their agency profile before entering the dashboard.
                </div>
              </div>
              <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-sm">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-sm">
                ...
                <div className="text-sm text-slate-600 mt-2 leading-6">
                  Route layouts, middleware, and tRPC procedures all validate the active Clerk session against the DB-backed auth role.
                </div>
              </div>
            </div>
          </div>
