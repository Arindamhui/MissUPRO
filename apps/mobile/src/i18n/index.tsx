...
const messages: Record<LocaleCode, DictionaryNode> = {
  en: {
    ...
    system: {
      authConfigMissingTitle: "Mobile auth config missing",
      authConfigMissingBody: "Set the required Google and API auth environment variables in apps/mobile/.env and restart Metro.",
      authConfigMissingHint: "The app stays mounted so Expo Router can finish startup without crashing while auth config is being fixed.",
    ...
    referrals: {
      ...
      shareMessage: "Join me on MissU Pro! Use my invite code: {code}\n\nDownload now and get bonus coins!",
  ...
  ar: {
    ...
    system: {
      authConfigMissingTitle: "إعداد المصادقة للموبايل مفقود",
      authConfigMissingBody: "قم بتعيين متغيرات بيئة Google و API المطلوبة في apps/mobile/.env ثم أعد تشغيل Metro.",
      authConfigMissingHint: "يبقى التطبيق محملاً حتى يكمل Expo Router بدء التشغيل بدون تعطل أثناء إصلاح الإعدادات.",
    ...
    referrals: {
      ...
      shareMessage: "انضم إليّ في MissU Pro! استخدم رمز الدعوة الخاص بي: {code}\n\nحمّل التطبيق الآن واحصل على عملات إضافية!",
  ...
  hi: {
    ...
    system: {
      authConfigMissingTitle: "मोबाइल ऑथ कॉन्फ़िगरेशन उपलब्ध नहीं है",
      authConfigMissingBody: "apps/mobile/.env में ज़रूरी Google और API ऑथ environment variables सेट करें और Metro दोबारा शुरू करें।",
      authConfigMissingHint: "ऐप माउंटेड रहता है ताकि कॉन्फ़िगरेशन ठीक करते समय Expo Router बिना क्रैश हुए स्टार्ट हो सके।",
    ...
    referrals: {
      ...
      shareMessage: "MissU Pro पर मेरे साथ जुड़ें! मेरा आमंत्रण कोड इस्तेमाल करें: {code}\n\nअभी डाउनलोड करें और बोनस कॉइन्स पाएं!",
