...
export default function SettingsScreen() {
  ...
  const sections: { title: string; rows: SettingRow[] }[] = [
    ...
    },
    {
      title: "Danger Zone",
      rows: [
        { label: "Sign Out", type: "action", danger: true, onPress: () => { signOut(); router.replace("/(auth)/login"); } },
        {
  ...
  return (
    <Screen>
      <ScrollView contentContainerStyle={{ padding: SPACING.md, paddingBottom: 40 }}>
        <Text style={{ fontSize: 24, fontWeight: "700", color: COLORS.text, marginBottom: SPACING.lg }}>Settings</Text>
